...
const Sidebar = ({ sidebarToggle }) => {
    return (
        <div className={`${sidebarToggle ? "hidden" : "block"} w-28 md:w-60  bg-gradient-to-b from-[#73e9fe] dark:from-[#8401A1] to-[#78118f] dark:to-[#73e9fe] absolute top-20 left-0 h-full px-4 py-2`}>
