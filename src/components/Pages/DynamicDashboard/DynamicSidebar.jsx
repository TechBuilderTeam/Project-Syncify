...
const DynamicSidebar = ({ sidebarToggle, id }) => {
  ...
  return (
    <div
      ...
      } w-40 md:w-60 bg-gradient-to-b from-[#73e9fe] dark:from-[#8401A1] to-[#78118f] dark:to-[#73e9fe] absolute top-20 left-0 h-screen px-4 py-2`}
    >
      <div className="my-2 mb-4">
        <h1 className="text-2xl font-bold text-center">Workspace Dashboard</h1>
      </div>
      <hr />
