                ...
                <thead className='bg-black text-white text-2xl'>
                    <tr>
                        ...
                        <th> <button className='btn-ghost'>  </button>
                            ...
                            <button className="btn btn-outline text-white" onClick={() => document.getElementById('my_modal_3').showModal()}>Add New Member</button>
                                    ...
                                    <div className="max-w-lg mx-auto bg-white p-8 rounded-md shadow-md">
                                        ...
                                        <form onSubmit={handleAddUserButton}>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input type="email" id="email" name="email" className="w-full text-black border-2 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500" placeholder="Enter email address" />
                                            </div>
                                            <div className="mb-4">
                                                <label htmlFor="userType" className="block text-gray-700 font-semibold mb-2">Roll</label>
                                            ...
                                            <div className="flex justify-between mb-4">
                                                ...
                                                <button type="submit" className="px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition duration-300 ease-in-out">Add New Member</button>
                                            </div>
                                        </form>
                                    </div>
