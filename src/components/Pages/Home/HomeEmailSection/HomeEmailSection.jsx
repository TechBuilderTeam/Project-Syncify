...
const HomeEmailSection = () => {
  return (
    <div className="w-full h-fit px-4 md:px-40 py-4 my-4">
      <div className="bg-gradient-to-b from-[#9d11bd] to-[#73e9fe] md:bg-gradient-to-r md:from-[#73e9fe] md:to-[#8401A1] dark:md:from-[#8401A1] dark:md:to-[#73e9fe] w-full rounded-2xl px-2 dark:text-[#8401A1] dark:md:text-[#73e9fe]">
