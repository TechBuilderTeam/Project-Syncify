    ...
    return (
        <div className='flex gap-4 my-10'>
                ...
                <div className='mx-4'>
                    ...
                    <button className="border-solid border border-slate-400 rounded py-2 px-8 my-4 bg-black text-white font-semibold hover:bg-red-400 hover:text-black ">Explore Product</button>
                </div>
            </div>
    );
};
